...
function blossom_speaker_customize_register( $wp_customize ){
    ...
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'blossom-speaker' ),  '<a href="' . esc_url( 'https://docs.blossomthemes.com/docs/blossom-speaker-free-wordpress-theme/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p>';
    ...
    <div class="bottom-footer">
        <div class="wrapper">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/blossom-speaker-free-wordpress-theme/' ) .'" rel="nofollow" target="_blank">' . esc_html__( ' Blossom Themes', 'blossom-speaker' ) . '</a>.';                
